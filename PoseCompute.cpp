...
Result PoseCompute::updateParameters(vector<p_match> &p_matched, vector<int32_t> &active, vector<double> &tr, double step_size, double eps) {
...
void PoseCompute::computeObservations(vector<p_match> &p_matched, vector<int32_t> &active) {
...
void PoseCompute::computeResidualsAndJacobian(vector<double> &tr, vector<int32_t> &active) {
...
vector<int32_t> PoseCompute::getInlier(vector<p_match> &p_matched, vector<double> &tr) {
